""" Pagan Divination - God class & instances """


class God:
    def __init__(self, name, gender, tribe, cz_description, en_description="english description") -> None:
        self.name = name
        self.gender = gender
        self.tribe = tribe
        self.cz_description = cz_description
...
heimdall = God("Heimdall", "M", "viking",
...
teutatis = God("Teutatis", "M", "celtic",
...
morrigan = God("Morrigan", "F", "celtic",
...
# list of gods (16)
gods = [
    thor, tyr, odin, frey, loki, freya, njord, baldr, frigg, hel, bragi, idunn, hodur, heimdall, ull,
    forseti, aegir, ran, eostre,
    taranis, teutatis, esus, epona, cernunn, maponos, eiocha, lugh, dagda, oghma, morrigan, brigit,
    bel, danu, grannus, sirona,
    rod, lada, triglav, svarog, perun, veles, mokos, nij, dazbog, chors, morana, dij, ziva, kascej,
    stribog, simargl
]

# ---------------------------
# Error god / Unknown god
unknown_god = God("Unknown god", "X", "no tribe",
                  "Tento bůh nebyl stvořen - ani narozen", "This god was never created - never born")
# print(len(gods))
